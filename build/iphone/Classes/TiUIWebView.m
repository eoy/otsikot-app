...
static NSString * const kOtsikotJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_otsikotInjection
{
	...
	[html appendString:kOtsikotJavascript];
...
{
	// attempt to make well-formed HTML and inject in our Otsikot bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _otsikotInjection]];
