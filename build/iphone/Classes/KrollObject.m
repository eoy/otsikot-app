 ...
 * Copyright (c) 2009-2011 by Otsikot, Inc. All Rights Reserved.
...
//@interface OtsikotObject : NSObject
//@end

@interface OtsikotObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[OtsikotObject class]])
		{
			for (NSString *key in [[(OtsikotObject*)o modules] allKeys])
			{
