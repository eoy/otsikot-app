...
// in simulator we redefine to format for Otsikot Developer console
...
{\
	NSString * exceptionName = [@"org.otsikot." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.otsikot";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIOtsikotNativeItemNone = -1, 
	UIOtsikotNativeItemSpinner = -2,
	UIOtsikotNativeItemProgressBar = -3,
	
	UIOtsikotNativeItemSlider = -4,
	UIOtsikotNativeItemSwitch = -5,
	UIOtsikotNativeItemMultiButton = -6,
	UIOtsikotNativeItemSegmented = -7,
	
	UIOtsikotNativeItemTextView = -8,
	UIOtsikotNativeItemTextField = -9,
	UIOtsikotNativeItemSearchBar = -10,
	
	UIOtsikotNativeItemPicker = -11,
	UIOtsikotNativeItemDatePicker = -12,
	
	UIOtsikotNativeItemInfoLight = -13,
	UIOtsikotNativeItemInfoDark = -14,
	
	UIOtsikotNativeItemDisclosure = -15,
	
	UIOtsikotNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Otsikot instances of
